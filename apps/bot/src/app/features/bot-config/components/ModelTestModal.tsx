          ...
          <div className="flex-1 min-h-0">
            <Tabs defaultValue="tab1" className="w-full h-full gap-0 overflow-hidden">
              <TabsList className="w-full p-0 bg-white rounded-none h-[48px] min-h-[48px]">
                <TabsTrigger
                  value="tab1"
                  className="!shadow-none border-1 border-b-[#E9EBEC] !rounded-none data-[state=active]:border-b-2 data-[state=active]:border-b-[var(--color-bt-primary)] data-[state=active]:text-[var(--color-bt-primary)]"
                >
                  학습모델
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="tab1" className="flex-1 min-h-0">
                <div className="w-full h-full overflow-y-auto p-5">
                  ...
                  <div className="flex gap-2 mb-3 items-end">
                    <div className="bg-[#405189] max-w-[80%] px-3 py-2 rounded-[12px] rounded-bl-[2px]">
