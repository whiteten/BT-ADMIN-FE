...
export default function IntentDetail() {
  ...
  const breadcrumb: BreadcrumbProps['items'] = [
    ...
    isPublic ? { title: '의도', path: `/bot/common/models/${modelId}?tab=tab2` } : { title: '의도', path: `/bot/bot-config/model/${modelId}?tab=tab2` },
    isPublic
      ? { title: '의도 상세', path: `/bot/common/models/${modelId}/intent/${intentId}` }
