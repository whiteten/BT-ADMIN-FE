    ...
    <div className="flex-1 min-h-0 overflow-auto bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-[1200px] mx-auto px-8 py-10 space-y-10">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-[13px] text-gray-600 leading-relaxed">
                IPRON 모듈은 콜센터의 <strong className="text-gray-800">교환기(PBX)</strong> 와{' '}
                <strong className="text-gray-800">CTI 분배</strong> 자원을 한 곳에서 운영합니다.
                국선·내선·라우팅·DNIS 변환 같은 회선 자원과 큐·스킬·상담사 같은 분배 자원을
                정의하고, 통합 콜트래킹으로 실제 호의 흐름과 통화 품질까지 한 화면에서 추적할 수 있습니다.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="text-[10px] text-gray-400 text-center pb-4">
          ※ 본 화면 정보는 bridgetec.co.kr 공식 IPRON 소개를 기반으로 작성되었습니다.
        </div>
      </div>
    </div>
  );
