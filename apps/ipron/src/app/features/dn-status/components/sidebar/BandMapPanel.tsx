  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mb-3 flex items-center gap-1.5 text-[10px] text-gray-500">
        <span className="inline-block size-2.5 rounded-sm" style={{ background: SEG_COLOR.free }} />
        <span>가용(유휴)</span>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="mb-4 rounded-md border border-dashed border-gray-300 bg-gray-50 px-6 py-6 text-center text-[12px] text-gray-400">등록된 대역이 없습니다.</div>
      ) : (
        <div className="mb-4">
          {bands.map((b) => (
