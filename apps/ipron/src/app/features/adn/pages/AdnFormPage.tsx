...
import type { AdnCreateRequest, AdnDefaultStateCode, AdnUpdateRequest } from '../types/adn.types';
import { ADN_DFT_STATE_OPTIONS, getAdnDftStateName, getDnStatusName } from '../utils/adnEnums';
...
export default function AdnFormPage() {
  ...
  // 모든 활성 테넌트 목록 — DN 내선관리(DnProfileFormPage)와 동일 hook 재사용
