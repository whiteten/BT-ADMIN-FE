          ...
          {remotes.map((remote) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'group/card flex items-center gap-3 rounded-xl bg-[#f8f9fb] hover:bg-[var(--color-bt-primary)]/[0.06] border border-transparent hover:border-[var(--color-bt-primary)]/20 px-4 py-3.5 text-left transition-colors',
