...
import { IconCalendar, IconDocument, IconLayer, IconRemoteAoe, IconSlidersHorizontal, IconTalk } from '@/components/custom/Icons';
...
const tabs: PageTab[] = [
  ...
  { id: 'tab6', label: 'AOE', icon: IconRemoteAoe, component: BotAoe },
];
