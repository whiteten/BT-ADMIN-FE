...
export default function EntityDetail() {
  ...
  useEffect(() => {
    ...
    setBreadcrumb(breadcrumb, { modelName: model?.modelName ?? '-', entityName: entity?.entityName ?? '-' });
    return () => clearBreadcrumb();
  }, [isPublic, modelId, entityId, model?.modelName, entity?.entityName, setBreadcrumb, clearBreadcrumb]);
