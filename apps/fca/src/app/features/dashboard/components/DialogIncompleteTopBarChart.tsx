...
import type { DialogIncompleteTopItem } from '../types';
  ...
  return {
    tooltip: {
      ...
      formatter: (params: unknown) => {
        ...
        return `${first.marker}<strong>${item.serviceName} &gt; ${item.dialogName}</strong><br/>미완료율: ${item.incompleteRate}%<br/>미완료: ${item.incompleteCnt}건<br/>진입: ${item.entryCnt}건`;
      },
    },
