...
export interface ExcelImportResultModalRef {
...
const ExcelImportResultModal = forwardRef<ExcelImportResultModalRef, ExcelImportResultModalProps>(({ nameColumnTitle }, ref) => {
...
ExcelImportResultModal.displayName = 'ExcelImportResultModal';

export default ExcelImportResultModal;
