...
import { useCreateCategory, useUpdateCategory } from '../hooks/useMaskPolicyQueries';
import type { MaskCategoryConfig, MaskCategoryConfigCreateRequest, MaskCategoryConfigUpdateRequest } from '../types';
