...
import { useGetTenant } from '../../features/tenant-management/hooks/useTenantQueries';
import { IconDocument, IconLayer, IconSlidersHorizontal, IconTalk } from '@/components/custom/Icons';
import PageTabs, { type PageTab } from '@/components/custom/PageTabs';

const TenantBasicInfo = React.lazy(() => import('../../features/tenant-management/tabs/TenantBasicInfo'));
const TenantOperationInfo = React.lazy(() => import('../../features/tenant-management/tabs/TenantOperationInfo'));
const TenantContractInfo = React.lazy(() => import('../../features/tenant-management/tabs/TenantContractInfo'));
const TenantCallGroup = React.lazy(() => import('../../features/tenant-management/tabs/TenantCallGroup'));
