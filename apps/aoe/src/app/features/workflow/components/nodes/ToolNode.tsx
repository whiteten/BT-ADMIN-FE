...
const TOOL_STYLE: Record<ToolNodeData['toolType'], { bg: string; ring: string; icon: typeof Server }> = {
  mcp: { bg: '#8B5CF6', ring: '#8B5CF633', icon: Server },
  default: { bg: '#3B82F6', ring: '#3B82F633', icon: Wrench },
};
    ...
    <div className="flex flex-col items-center select-none pointer-events-none">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `0 0 0 3px ${style.ring}, 0 1px 2px rgba(15, 23, 42, 0.08)`,
        }}
      >
