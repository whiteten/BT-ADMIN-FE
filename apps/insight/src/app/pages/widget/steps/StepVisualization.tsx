  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <Form form={form} layout="vertical">
        ...
        <Card size="small" title="카드 뷰 설정" className="mt-4">
          <div className="grid grid-cols-2 gap-4">
            <Form.Item label="카드 크기">
              <Radio.Group defaultValue="medium" buttonStyle="solid">
                <Radio.Button value="small">소 (4열)</Radio.Button>
                <Radio.Button value="medium">중 (3열)</Radio.Button>
                <Radio.Button value="large">대 (2열)</Radio.Button>
              </Radio.Group>
            </Form.Item>
            <Form.Item label="카드 높이">
