...
export const DEMO_HEALTH: HealthBoardData = {
  ...
  answeredCnt: 1186,
  waitingCnt: 17,
  alarm: { notice: 2, warning: 1, danger: 1 },
  systems: [
    { code: 'IE', name: 'IE 교환기', up: 8, total: 8, severity: 'success' },
    { code: 'IC', name: 'IC CTI', up: 4, total: 4, severity: 'success' },
    { code: 'IR', name: 'IR IVR', up: 7, total: 8, severity: 'warning' },
  ],
  queues: [
    { id: 'vip', name: 'VIP 상담', waitCnt: 32, barPct: 100, sev: 'danger' },
    { id: 'normal', name: '일반 상담', waitCnt: 18, barPct: 56, sev: 'warning' },
    { id: 'team2', name: '상담2팀', serviceLevel: 84, barPct: 42, sev: 'notice' },
  ],
  normalQueueCnt: 5,
