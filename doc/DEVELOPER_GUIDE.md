...
이 프로젝트는 **turborepo(pnpm workspace) 모노레포** + **Rsbuild(rspack) + Module Federation** 기반의 마이크로 프론트엔드입니다. (2026-07 Nx+Webpack에서 전환 — 배경·성능 비교는 [docs/MIGRATION-LOG.md](../docs/MIGRATION-LOG.md) 참조)
